...
The notebooks use four datasets, each explained in local README files: the AutoMPG dataset, the Titanic dataset, the MNIST number dataset, and the MNIST fashion dataset.
