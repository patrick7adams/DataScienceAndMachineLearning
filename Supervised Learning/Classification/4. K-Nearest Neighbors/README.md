...
This Jupyter notebook implements the KNN algorithm to classify the Titanic dataset. We then explore the differences between the KNN algorithm on the data with PCA applied and the full-dimension data with different k-values and different distance functions.
