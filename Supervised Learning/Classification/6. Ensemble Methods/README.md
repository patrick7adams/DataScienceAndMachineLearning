...
This Jupyter notebook implements and compares several ensemble methods, including bagging with different base classifiers and random forest. It then compares the classification error for all of these algorithms when trained and predicting the full dimension data, displaying a table of the classification errors.
