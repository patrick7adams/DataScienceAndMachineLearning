...
This Jupyter notebook implements the Decision tree classification algorithm and visualizes its results through various tree visualizations, a confusion matrix plot, and a decision region plot. Next, classification errors for different maximum decision tree depths are displayed for both the PCA data subset and the full dimension data.
