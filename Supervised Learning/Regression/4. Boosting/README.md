...
This Jupyter notebook explores gradient boosting when applied with the decision tree regressor. It then plots the boosting with decision trees of max depth 2 with a varied number of estimators, and outputs the MSE with the varied estimators. It then repeats this process for the full dataset.
