...
This Jupyter notebook explores the preprocessing of the AuitoMPG dataset, building training and testing datasets for the features and the targets of this dataset. Then, it outputs all data to file for use in other regression and clustering notebooks.
