...
This Jupyter notebook explores K-means clustering and its application to the AutoMPG dataset. It then plots the chosen clusters while varying the number of clusters, and calculates the Silhouette score of each number of cluster.
